          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                ...
                {/* Askalyze extracts insights, generates summaries, and creates custom outputs, streamlining document analysis and improving decision-making without manual data processing. */}
              </p>
            </motion.div>
          </div>
        </div>
